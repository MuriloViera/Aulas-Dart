  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Container(
        ...
        // LISTVIEW
        //
        child: ListView(//O Listview, ja tem um scroll
          children: [
            ...
            ListTile(//O ListTile é um elemento da lista, serve como um decoration tb
              
              leading: Icon(Icons.label, color: Colors.grey),//Icone do lado esquerdo do titulo do list view
              trailing: Icon(Icons.build, color: Colors.grey),//Icone do lado direito do titulo do list view
        ...
        children: [
          ...
          Container(
            ...
            height: 320,
              ...
              // ListView.builder
              //
              child: ListView.builder(//No list builder, eu defino a aparecia de um item e depois a quantidade de itens
                ...
                itemBuilder: (context,index){
                  return Container(
                    ...
                    child: Center(child: Text('Item $index')),//No list builder, meu dados de cada item, vem de uma lista declarada como variável,
                                                              //do banco de dados ou que eu mesmo declarei, assim $lista{index}
                  );
                },
...
class _ListViewSeparetedState extends State<ListViewSepareted> {
  ...
  var txtTarefa = TextEditingController();//TextEditingControler é pra quando o usuário digitar na variável, eu pegar o que ele digitou

  @override
  void initState(){
    super.initState();//O super dispara o initState do pai State<ListViewSepareted>, basicamente o super inicializa o State para poder começar a lista
  ...
  Widget build(BuildContext context) {
    return Scaffold(
          ...
          itemBuilder: (context,index){
            return ListTile(
              ...
              trailing: IconButton(
                ...
                onPressed: (){
                  setState(() {
                    lista.removeAt(index);//Lista removeAt remove o item da lista
                    ScaffoldMessenger.of(context).showSnackBar(//ScaffoldMessenger é pra aparecer uma notificação que aparece e some
                      SnackBar(
      ...
      floatingActionButton: FloatingActionButton(
        ...
        onPressed: () async {//A função future, faz com que a lista fique esperando o resultado do onPressed,por isso o await
          await showDialog(
            context: context,
            builder: (context){
              return AlertDialog(
